...
const updateValues = () => {
  ...
  props.setWayPointsArray(updatedArray);
        ...
        <span className='w-auto h-auto'>
            <InputText ref={waypointRef} onBlur={updateValues}  className='p-4 text-s
             sm:text-md
             tablet:text-lg tablet:w-auto tablet:p-3 rounded-full shadow-none focus:border-none focus:outline-none  focus:shadow-none focus:bg-green-500 focus:text-white'/>
